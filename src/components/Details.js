...
const Details = () => {
    ...
    const savetocart=async(e)=>
    {
        ...
        else
        {
            ...
            {
                var tc=remamt*qty;
                const cartdata = {prodid,pic:pdata.picture,pname:pdata.prodname,rate:remamt,qty,tc,uname:userinfo.username}
                ...
                <div className="container">
                    <div className="agileinfo_single">
                        ...
                        <div className="col-md-4 agileinfo_single_left">
                            <img id="example" src={`uploads/${pdata.picture}`} alt=" " className="img-responsive" />
                        </div>
