...
const Checkout=()=>
{
	...
	const saveorder=async(e)=>
	{
		...
		try
		{
            ...
            const apidata = {uname:userinfo.username,addr,pmode,carddetails,tbill:sessionStorage.getItem("billamt"),orderitems:JSON.parse(sessionStorage.getItem("cartitems"))}
			...
			if(apiresp.status===200)
			{
				...
				{
					toast.error("Error while placing the order, try again")
				}
			}
			else
			{
